...
class VeganMapsFragment : Fragment() {
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                for (dato: DataSnapshot in snapshot.child("veganos").children) {
                    ...
                    googleMap.addMarker(MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)).position(pos).title(restauranteServer.id))
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_vegan_maps, container, false)
    }
