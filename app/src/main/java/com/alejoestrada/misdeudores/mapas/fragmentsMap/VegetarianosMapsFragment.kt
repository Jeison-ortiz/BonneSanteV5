...
class VegetarianosMapsFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                for (dato: DataSnapshot in snapshot.child("vegetarianos").children) {
                    ...
                    restauranteServer?.let {
                        ...
                        googleMap.addMarker(MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)).position(pos).title(restauranteServer.id))
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_vegetarianos_maps, container, false)
    }
